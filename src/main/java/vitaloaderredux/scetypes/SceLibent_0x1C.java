...
//Used in firmware 0.931 and earlier
public class SceLibent_0x1C extends ILibent{
public static final int SIZE = 0x1C;
	
	public SceLibent_0x1C(BinaryReader reader) throws IOException {
		...
		libraryNID = ILibent.UNKNOWN_NID; //See SceLibstub_0x2C for the rationale.
